...
public class UF {
     ...
     *
     * @param p entero representado en un solo sitio
     * @return el conjunto identificador de el conjunto situado en {p}.
     */
     ...
     *
     * @return el numero de los componentes (entre {1} y {n})
     */
    public int cont() {
        return cont;
    }
     ...
     *
     * @param p entero representado en un solo sitio
     * @param q entero representado en otro sitio
     ...
     *
     * @param p entero representado en un sitio
     * @param q entero representado en otro sitio
     */
